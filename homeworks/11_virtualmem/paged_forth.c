...
// the number of memory pages will allocate to an instance of forth
#define NUM_PAGES 20

// the max number of pages we want in memort at once, ideally
#define MAX_PAGES 3

static void error_handler(int sig, siginfo_t *si, void *unused)
{
...
int main() {
    ...
    //Add a bunch of segmentation fault handler setup here for
